...
public class MenuAnimation<T> implements Menu<T> {
    ...
    private List<Selection> subMenuListSelection;
    private Map<String, Menu<T>> sunMenu = new HashMap<>();
     ...
     *                       the constructor
     */
    public MenuAnimation(KeyboardSensor keyboardSensor, String title, T status) {
        this.status = status;
        this.keyboardSensor = keyboardSensor;
        this.title = title;
        this.listSelection = new ArrayList<>();
        this.subMenuListSelection = new ArrayList<>();
    }
    ...
    public void addSubMenu(String key, String message, Menu<T> subMenu) {
        this.subMenuListSelection.add(new Selection(key, message, subMenu));
    }
